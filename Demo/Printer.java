...
public interface Printer extends com.zeroc.Ice.Object
{
    ...
    **/
     ...
     * @return -
    **/
    static java.util.concurrent.CompletionStage<com.zeroc.Ice.OutputStream> _iceD_validateString(Printer obj, final com.zeroc.IceInternal.Incoming inS, com.zeroc.Ice.Current current)
    {
        com.zeroc.Ice.Object._iceCheckMode(null, current.mode);
        com.zeroc.Ice.InputStream istr = inS.startReadParams();
        String iceP_s;
        ...
        inS.endReadParams();
        boolean ret = obj.validateString(iceP_s, current);
        com.zeroc.Ice.OutputStream ostr = inS.startWriteParams();
        ostr.writeBool(ret);
        inS.endWriteParams(ostr);
        return inS.setResult(ostr);
    ...
    **/
        ...
        throws com.zeroc.Ice.UserException
    {
        ...
        switch(pos)
        {
            case 0:
            {
                return _iceD_findClosestPrime(this, in, current);
            }
            case 1:
            {
